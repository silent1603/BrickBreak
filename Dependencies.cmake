...
function(brickbreak_setup_dependencies)
  ...
  # add_library(rlimgui INTERFACE) target_sources(rlimgui PRIVATE
  # ${rlimgui_SOURCE_DIR}/rlImGui.cpp)
  target_link_libraries(rlimgui PUBLIC imgui raylib)
  # target_link_libraries(rlimgui INTERFACE imgui raylib) if(APPLE)
  # target_link_libraries(rlimgui PUBLIC "-framework IOKit")
  # target_link_libraries(rlimgui PUBLIC "-framework Cocoa")
  # target_link_libraries(rlimgui PUBLIC "-framework OpenGL") endif()
