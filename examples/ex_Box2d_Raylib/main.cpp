...
void DrawEntity(const Entity* entity)
{
	...
	b2Vec2 p = b2Body_GetWorldPoint(entity->bodyId,{ -entity->extent.x, -entity->extent.y });
...
int main(void)
{
	...
	Texture groundTexture = LoadTexture("resources/images/ground.png");
	Texture boxTexture = LoadTexture("resources/images/box.png");
